class QualificationsController < ApplicationController
  ...
  private
    ...
    def qualification_params
      params.require(:qualification).permit(:high_school_percentage, :intermediate_percentage, :graduation_course, :graduation_percentage, :graduation_passing_year, :employee_id)
    end
end
